    ...
    <div class="contact-page">
        ...
        <div class="contact-page__info">
            <div class="contact-info-card">
                ...
                <ul class="contact-info-list">
                    ...
                    <li>
                        ...
                        <div>
                            ...
                            <span><?php echo esc_html(scaff_get('scaff_contact_address', 'Vilnius, Lietuva')); ?></span>
                        </div>
                    </li>
                    <li>
                        ...
                        <div>
                            ...
                            <span><?php echo esc_html(scaff_get('scaff_contact_hours', 'I – V: 8:00 – 17:00')); ?></span>
                        </div>
                    </li>
                </ul>
                ...
                $yt = scaff_get('scaff_footer_yt_url');
                ?>
                <?php if ($fb || $ig || $li || $yt): ?>
                <div class="contact-social">
                    ...
                    <div class="contact-social__links">
                        ...
                        <?php endif; ?>
                        <?php if ($yt): ?>
                        <a href="<?php echo esc_url($yt); ?>" class="contact-social__link" target="_blank" rel="noopener" aria-label="YouTube">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.42a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33 2.78 2.78 0 001.94 2c1.72.42 8.6.42 8.6.42s6.88 0 8.6-.42a2.78 2.78 0 001.94-2 29 29 0 00.46-5.33 29 29 0 00-.46-5.33z"/><path d="M9.75 15.02l5.75-3.27-5.75-3.27v6.54z" fill="var(--dark)"/></svg>
                        </a>
                        <?php endif; ?>
                    </div>
                </div>
