...
function scaff_customizer_register($wp_customize) {
    ...
    for ($i = 1; $i <= 4; $i++) {
        scaff_add_setting($wp_customize, "scaff_stat_{$i}_number", ['1' => '500+', '2' => '15+', '3' => '30', '4' => '100%'][$i], 'scaff_home_other', 'text');
        scaff_add_setting($wp_customize, "scaff_stat_{$i}_label", ['1' => 'Produktų kataloge', '2' => 'Metų patirtis', '3' => 'Dienų grąžinimas', '4' => 'Kokybės garantija'][$i], 'scaff_home_other', 'text');
